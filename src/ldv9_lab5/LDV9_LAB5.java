...
public class LDV9_LAB5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton_Save.setBounds(850, 380, 80, 23);
        ...
        jButton_Save1.setBounds(950, 380, 80, 23);
        ...
        jTextField_FIOsender.setBounds(700, 80, 260, 20);
        ...
        jTextField_Phone.setBounds(700, 170, 270, 20);
        ...
        jTextField_IINrecepient.setBounds(630, 267, 270, 23);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ldv9_lab5/post.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LDV9_LAB5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
